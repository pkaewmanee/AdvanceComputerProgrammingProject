  ...
  while (choice != 3) {
    ...
    case 1: {
      if (pds.isEmpty() == 1) {
        ...
        if (name != pds.find(name)->get_data()->get_name()) {
    ...
    case 2: {
      ...
      while (choice != 4) {
        ...
        display_data(f, sort_wel, sort_sat, sort_qual, mean1, median1, mode1,
                     numf, choice);
      ...
      cout << "The Data of Professor " << find_name << " is now unaccessible."
           << endl;
